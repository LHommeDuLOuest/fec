 ...
 * @author KHERBICHE L
 */
public class CORSFilter_Sec implements ContainerResponseFilter, ContainerRequestFilter {
	
	private static final Log logger = LogFactory.getLog(CORSFilter_Sec.class);
	...
	public void filter(ContainerRequestContext requestContext, ContainerResponseContext responseContext)
		...
		headers.add("Access-Control-Allow-Origin", "https://www.google.fr");
    ...
    private boolean isUserAllowed(final String username, final String password, final Set<String> rolesSet) {
        ...
        if(username.equals("fecats?mail_") && password.equals("_passfec?_ats_mail")) {
